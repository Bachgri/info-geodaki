...
//addDirNums();
    ...
    //     $("#exportContent").removeAttr('hidden')
    //     doc.fromHTML(document.getElementById("exportContent"),5,5) 
    //     $("#exportContent").attr('hidden', 'true') 
    //     doc.save('Taux_Realisation_'+new Date()+'.pdf');
    // }); 
    ...
    function generatePDF() {
        ...
        doc.save("Taux_Collection"+d.getDay() + '/' + (d.getMonth()+1) + '/' + (d.getYear()+1900) + '  ' +d.getHours()+'h'+d.getMinutes()+ +".pdf")
